...
opt_param_df = read.csv("opt_parameters.csv") #Usind the same optimal parameters as the real data
...
crqa_m1 = lm(Resp_RR~1+Pair,rqa_allPairs)
summary(crqa_m1)
anova(crqa_m1)
crqa_m2 = lm(HR_RR~1+Pair,rqa_allPairs)
summary(crqa_m2)
...
#You can look at the other crqa parameters for Resp? 
```
...
```{r}
paste("dataProc/",file,".csv",sep = "")

path = paste("dataProc/",file[i],".csv",sep = "")

prepro_filelist = list.files(path = "C:/Users/Ejer/Desktop/3. semester/Experimental Methods 3/Assignment4/dataProc/", pattern = "Study1")  # load the preprocessed files
